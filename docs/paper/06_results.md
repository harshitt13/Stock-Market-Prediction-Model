...
0.177 (Transformer, DM = −1.35) and among the baselines 0.174 (historical
...
+1.71, p = 0.087; Holm-corrected over the nine strategies tested, p = 0.698.
Under a pure null with nine correlated tests (ρ = 0.8) the expected maximum
|t| was 1.40 and P(max|t| ≥ 1.71) = 0.27; with nine independent tests, 1.84
and 0.56 (`analysis/alpha_correction_and_window.py`; README §3.4). A t of
1.71 is what no alpha looks like when one looks nine times. Raising the
